...
const CategoryProducts = () => {
  ...
  const handleGoBack = () => {
    ...
    navigate(`${prefix}/mange-categories`);
  };
    ...
    <div className="admin-page">
      ...
      <div className="admin-header">
        <div style={{ display: "flex", alignItems: "center", gap: "15px" }}>
          ...
          <h1>{decodeURIComponent(categoryName)} - Products</h1>
        </div>
      ...
      <div className={`add-product-overlay ${showAddForm ? 'active' : ''}`}>
        <div className="overlay-content">
          ...
          <div className="overlay-body">
            <AddProduct 
              feathedproducts={fetchProducts}  
              onClose={() => setShowAddForm(false)}
              showToast={showToast}
              defaultCategory={decodeURIComponent(categoryName)}
            />
          </div>
        </div>
      </div>

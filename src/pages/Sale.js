...
function Sale(){
  ...
  <>
    ...
    <FilterBar toggleSidebar = {toggleSidebar} layoutSwitch= {layoutSwitch} setSortOption={setSortOption} products={filteredProducts.filter(
    ...
    <div className="page-content-filterbar-sidebar">
            ...
            <ProductsSection badgeType="sale" layout={isLayout} page={page} productsPerPage={PRODUCTS_PER_PAGE} sortedFilteredProducts= {filteredProducts}/>
        </div>
        {/* Pagination */}
